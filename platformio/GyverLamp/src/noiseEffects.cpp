...
// котором храним вычисленные значения шума)
...
void rainbowStripeNoise() {
  if (loadingFlag) {
    ...
    scale = modes[10].scale/8;
    speed = modes[10].speed/3;
    colorLoop = 1;
  }
  fillNoiseLED();
}
